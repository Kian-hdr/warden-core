...
The [build gallery](media-gallery.md) shows the physical assembly in open and folded configurations. The [CAD package](../subsystems/airframe/landing-gear/) preserves the LL-11 source and exchange files. The [software package](../subsystems/observability/) can be explored with synthetic data without connecting any vehicle.

## Source basis

This public explanation is grounded in the dated project records identified in the [source records for this chapter](evidence/source-records.md#chapter-docs-overview-md). The catalogue distinguishes complete notices from adapted explanations and preserves separate document versions.
