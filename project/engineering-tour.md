...
I led Annihilation Industries at the European Defense Tech Hackathon in Hamburg, connecting the simulation and evaluation work with the team’s hardware, perception and sensing contributions. [Vincent · vwiczk](https://github.com/vwiczk) developed the separate computer-vision baseline, [Constantin · Takane0](https://github.com/Takane0) and I worked together on the airframe design; I developed the landing gear, and he handled Raspberry Pi–Pixhawk integration and flight-controller programming/configuration, and Leon developed the related Warden Corps multi-camera sensing study and presentation.
...
| **[Vincent · vwiczk](https://github.com/vwiczk)** | [Computer vision](../subsystems/perception/README.md) | Frozen ResNet18 features, linear six-class head, offline training/evaluation and explicit unknown behavior. |
