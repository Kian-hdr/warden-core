...
The [source records for this chapter](evidence/source-records.md#chapter-docs-development-md) identify the archived versions used in this public explanation.
