...
The images are backed by source files, media identities and documented scope. [Software engineering](../../software/engineering.md) explains the event and capture contracts; [reproducibility](../project/reproducibility.md) explains how hashes, original files and public viewing copies are kept distinct. This lets a reader move from a picture to the implementation or the record that gives it meaning.
