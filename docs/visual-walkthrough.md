...
The supplied video shows the physical prototype airborne and hovering. [Watch the recorded demonstration](../media/videos/prototype-hover.mp4?raw=1). This is a concrete physical-build result. The public copy retains the full recording duration and presents the visible physical-build achievement directly.
...
[![Model-based autonomous corridor flight](../media/videos/model-based-autonomous-corridor.png)](../media/videos/model-based-autonomous-corridor.mp4?raw=1)
