...
| --- | --- | --- |
| August 28–30, 2026 | Kian’s simulation planning, environment setup, contract/dynamics checks, replay, scale profiling, partial training and media preservation | [Source-linked experiment results](../../results/README.md); the retained Stage 0 tranche is not a fully trained flight policy. |
