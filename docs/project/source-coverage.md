...
The [reproducibility chapter](reproducibility.md) explains source/public hashes and remote readback. The [experiment-artifact chapter](../simulation/artifact-lineage.md) explains the relationship between source, configuration, checkpoints, exports and review records.
