...
| **[Constantin](https://github.com/Takane0)** | Physical prototype assembly, folding airframe and flight-controller/electronics integration work. | [Hardware integration history](../subsystems/hardware-integration.md), [photographs and hover](../../media/physical/README.md). The recording’s control mode is undocumented; later Pi software work is not automatically attributed to the hardware owner. |
