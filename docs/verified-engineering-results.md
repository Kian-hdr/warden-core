...
- the bounded reward ledger and terminal-dominance invariant documented in the [reward-policy chapter](reward-policy-overview.md); and
...
Model weights are intentionally absent from this repository. They remain closed-source project artifacts governed by the [model-access policy](../MODEL-ACCESS.md).
