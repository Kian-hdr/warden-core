...
[![Model-based autonomous trajectory controller in the fictional corridor](../media/videos/model-based-autonomous-corridor.png)](../media/videos/model-based-autonomous-corridor.mp4?raw=1)
...
[![Warden Iris simulation montage](../media/videos/verified-simulation-montage.png)](../media/videos/verified-simulation-montage.mp4?raw=1)
...
| --- | --- |
| [![Mapped-course chase view](../media/videos/course-baseline-chase.jpg)](../media/videos/course-baseline-chase.mp4?raw=1) | [![Mapped-course FPV view](../media/videos/course-baseline-fpv.jpg)](../media/videos/course-baseline-fpv.mp4?raw=1) |
...
[![Physical prototype hover](../media/physical/outdoor-hover.jpg)](../media/videos/prototype-hover.mp4?raw=1)
...
Simulation footage was rendered in NVIDIA Isaac Sim. The Iris surrogate remains subject to the upstream notices in [`third_party/`](../third_party/README.md). The project media licence covers the project-created scene composition, camera work, labels and presentation to the extent those rights are held by the project contributor.
