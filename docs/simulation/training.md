...
The [acro-racing reward-policy specification](../../policies/reward-policy.md) reproduces the recorded reward equations, term coefficients, bounded ledger and terminal-dominance proof. [Source coverage](../project/source-coverage.md) identifies that adapted scope and the complete original documents retained privately.
