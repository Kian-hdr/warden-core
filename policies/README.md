...
Completed numerical outcomes are in [verified results](../results/README.md). Model binaries remain closed source under the [model-access policy](../licensing/model-access.md).
