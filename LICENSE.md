...
| Project-owned prose, diagrams and machine-readable documentation in [`README.md`](README.md), [`docs/`](docs/), [`policies/`](policies/), [`results/`](results/), [`subsystems/`](subsystems/) and project-owned portions of [`presentations/`](presentations/) | [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International](licensing/licenses/CC-BY-NC-SA-4.0.md) |
...
Model weights, checkpoints and exported policy artifacts remain closed source. The [model-access policy](licensing/model-access.md) explains how commercial, education and academic requests are reviewed.
