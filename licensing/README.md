...
This directory is the canonical licensing entry point for Warden Core.

| Need | Read |
| --- | --- |
| Understand which licence covers each folder | [Top-level licence map](../LICENSE.md) |
| Use project-owned software noncommercially | [PolyForm Noncommercial 1.0.0](licenses/PolyForm-Noncommercial-1.0.0.md) |
| Reuse project-owned documentation or listed media | [CC BY-NC-SA 4.0](licenses/CC-BY-NC-SA-4.0.md) |
