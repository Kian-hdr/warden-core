...
The material identified by this repository's licence map is licensed under the **Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International Public License**.

- SPDX identifier: `CC-BY-NC-SA-4.0`
- Human-readable summary: <https://creativecommons.org/licenses/by-nc-sa/4.0/>
- Complete legal code: <https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.en>
- Plain-text legal code: <https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.txt>
