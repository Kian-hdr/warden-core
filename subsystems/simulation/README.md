...
[Architecture](docs/architecture.md) · [Training](docs/training.md) · [Reward and evaluation](reward-and-evaluation/README.md) · [Run identities](results/run-identities.md) · [Simulation media](media/simulator/README.md) · [Autonomous corridor](media/autonomous/README.md)
...
- [Observation and action contracts](reward-and-evaluation/observation-action-contracts.md)
- [Evaluation methodology](reward-and-evaluation/evaluation-methodology.md)
- [Verified result table](../../project/evidence/README.md)
