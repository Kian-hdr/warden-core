...
Our [gallery](../../../project/media-gallery.md) therefore labels each published clip for its actual role: checkpoint playback, baseline course visualization, camera development or a physical prototype recording. Readers can follow an image into the relevant chapter without confusing the way a clip was produced with the capability it demonstrates.

## Source basis

This public explanation is grounded in the dated project records identified in the [source records for this chapter](../../../project/evidence/source-records.md#chapter-docs-artifact-lineage-md). The catalogue distinguishes complete notices from adapted explanations and preserves separate document versions.
