...
[Complete Isaac-agent subsystem guide](../README.md) · [Policy specifications](../reward-and-evaluation/README.md) · [Verified run identities](../results/run-identities.md)
...
The camera workflow produced frame sequences and encoded video. The public [autonomous corridor demonstration](../../../project/evidence/media-provenance.md#model-based-autonomous-corridor-flight) connects a source revision, physically simulated vehicle, model-based trajectory controller, runtime measurements, 450 source frames and independent technical/visual review. The [verified simulation montage](../../../project/evidence/media-provenance.md#verified-simulation-montage) combines exterior, chase and first-person camera work with explicit title cards.
...
This decision preserved a repeatable model/runtime combination. It was not a digital-twin claim about the physical frame. The public [media credits](../../../licensing/third-party/README.md) retain the relevant upstream notices; the [visual walkthrough](../../../project/visual-walkthrough.md) makes the difference between the simulated Iris and the actual prototype visible.

## Source basis

This public explanation is grounded in the dated project records identified in the [source records for this chapter](../../../project/evidence/source-records.md#chapter-docs-simulation-md). The catalogue distinguishes complete notices from adapted explanations and preserves separate document versions.
