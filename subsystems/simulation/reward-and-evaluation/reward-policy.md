...
This is a newly written public adaptation of the archived design records. It reproduces the recorded reward equations and coefficients above, but does not reproduce aircraft-control interfaces, course-generation implementation, pursuit/interception logic, or vehicle-operation instructions. [Source coverage](../../../project/source-coverage.md) identifies the publication forms.

## Source basis

This public explanation is grounded in the dated project records identified in the [source records for this chapter](../../../project/evidence/source-records.md#chapter-policies-reward-policy-md). The catalogue distinguishes complete notices from adapted explanations and preserves separate document versions.
