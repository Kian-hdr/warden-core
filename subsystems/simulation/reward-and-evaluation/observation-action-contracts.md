...
The public [system architecture](../docs/architecture.md) shows this interface in the full Isaac Sim loop. The [verified results](../../../project/evidence/README.md) record the completed contract, dynamics and replay checks.
