...
- [Isaac Sim agent and policy loop](../simulation/README.md)
- [Computer-vision model](../perception/README.md)
- [Multi-camera sensing study](../multicamera-sensing/README.md)
- [Physical airframe and electronics](../airframe/docs/integration.md)

The [presentation package](../../project/presentations/README.md) explains how those contributions fit together.
...
Project-owned source code and examples in this directory are available under the [PolyForm Noncommercial License 1.0.0](../../licensing/scopes/software.md). It permits the noncommercial uses defined in that licence, including personal research and use by educational institutions. Commercial use requires a [separate written paid agreement](../../licensing/commercial-licensing.md).
