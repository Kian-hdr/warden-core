...
| View | Record |
| --- | --- |
| Assembly and wiring | ![Open frame and wiring](../media/assembly-wiring.jpg) |
| Open configuration | ![Prototype open](../media/prototype-open.jpg) |
| Folded configuration | ![Prototype folded](../media/prototype-folded.jpg) |
| Outdoor hover | [![Prototype hovering](../media/outdoor-hover.jpg)](../media/prototype-hover.mp4?raw=1) |

The separate LL-11 package adds editable parametric landing-leg geometry, STEP/STL exchange files and digital integrity checks. See [hardware](../landing-gear/README.md).
