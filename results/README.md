...
[Run and evidence identities](run-identities.md) · [Machine-readable results](verified-results.json) · [Public source records](source-records.md) · [Media manifest](../media/manifest.json) · [Policy specifications](../policies/README.md)
...
- the bounded reward ledger and terminal-dominance invariant documented in the [reward-policy chapter](../policies/reward-policy.md); and
...
[Watch the autonomous corridor demonstration](../media/autonomous/corridor-flight.mp4?raw=1) or read its [media provenance](../media/provenance.md).
...
The public [observability toolkit](../software/README.md) demonstrates the same design principles with strict event parsing, causal timestamp checks, content hashing and non-overwriting outputs.
